...
/**
 * The multi-step "Get a free quote" form card. Shared by the hero and the
 * #quote contact section. Front-end demo — wire `submit` to your CRM/email.
 */
export function QuoteFormCard({ className = "" }: { className?: string }) {
  ...
  return (
    <div
      className={`w-full rounded-[1.75rem] border border-white/10 bg-white p-6 shadow-lift sm:p-8 ${className}`}
    >
                ...
                >
                  ...
                  {step === 1 && (
                    <div className="space-y-5">
                      ...
                      <div>
                        <label htmlFor={`${uid}-bedrooms`} className="text-sm font-semibold text-ink">
                          Bedrooms
                        </label>
                        <div className="mt-2.5 grid grid-cols-3 gap-2 sm:grid-cols-6" id={`${uid}-bedrooms`}>
                          {sizeOptions.map((b) => {
                  ...
                  {step === 2 && (
                    <div className="space-y-4">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                          <label htmlFor={`${uid}-phone`} className="text-sm font-semibold text-ink">
                            Phone
                          </label>
                          <input
                            id={`${uid}-phone`}
                      ...
                      <div>
                        <label htmlFor={`${uid}-date`} className="text-sm font-semibold text-ink">
                      ...
                      <div>
                        <label htmlFor={`${uid}-notes`} className="text-sm font-semibold text-ink">
